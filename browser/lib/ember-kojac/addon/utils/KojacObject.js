...
(function(){
  ...
  ko = function(aProperties){
	...
	ko.prototype.init = function(aProperties) {
		_.extend(this,aProperties);
	};
	ko.prototype.toJSON = function() { // this adds an instance method used by JSON2 that returns an object containing all immediate and background properties (ie from the prototype)
		return _.clone(this);
	};


	var extendfn = function(prop) {
  // Create a new JrClass that inherits from this class
    ...
    JrClass.extend = extendfn; //eval('arguments.callee'); //arguments.callee;
